...
export const SaperRow = (props) => {
    ...
    const columns = Array(props.columnNumber).fill(0).map((_, i) => <SaperCell key={i} columnNumber={props.columnNumber} rowId={props.rowId} columnId={i} rowNumber={props.rowNumber} openCell={props.openCell}
